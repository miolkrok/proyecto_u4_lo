...
@NamedNativeQueries({
		@NamedNativeQuery(name = "Persona.buscaPorCedulaNative", query = "SELECT * FROM persona WHERE pers_cedula = :datoCedula", resultClass = Persona.class),
		@NamedNativeQuery(name = "Persona.buscaPorCedulaNativeApellido", query = "SELECT * FROM persona WHERE pers_cedula = :datoCedula",resultClass = Persona.class) })
